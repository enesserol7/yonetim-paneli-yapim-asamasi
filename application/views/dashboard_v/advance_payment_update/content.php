        ...
        <div class="col-xl-12">
            ...
            <div class="widget has-shadow">
                ...
                <div class="widget-body">
                    <form class="needs-validation" novalidate action="<?php echo base_url("dashboard/advance_payment_confirmation/$item->id"); ?>" method="post">
                        ...
                        <div class="form-group row d-flex align-items-center mb-5">
                            <label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Kalan Tutar *</label>
                            <div class="col-lg-5">
                                <input class="form-control" placeholder="Kalan Tutar" name="remaining_payment" disabled value="<?php echo isset($form_error) ? set_value("remaining_payment") : "$item->remaining_payment"; ?>">
                                <?php if (isset($form_error)) { ?>
                                    <small class="input-form-error pull-right"><?php echo form_error("remaining_payment"); ?></small>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group row d-flex align-items-center mb-5">
                        ...
                        <div class="text-right">
                            ...
                            <a href="<?php echo base_url("dashboard/personnel_advance_claim_list"); ?>" class="btn btn-shadow">Geri Dön</a>
                        </div>
                    </form>
                </div>
            </div>
