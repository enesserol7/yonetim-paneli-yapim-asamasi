		...
		<div class="col-xl-12">
			...
			<div class="widget has-shadow">
				...
				<div class="widget-body">
					<form class="needs-validation" novalidate action="<?php echo base_url("institutions/update/$item->id"); ?>" method="post">
						<div class="form-group row d-flex align-items-center mb-5">
							<label class="col-lg-4 form-control-label d-flex justify-content-lg-end">Kurum Adı *</label>
							<div class="col-lg-5">
								<input class="form-control" placeholder="Kurum Adı" name="title" value="<?php echo isset($form_error) ? set_value("title") : "$item->title"; ?>">
						...
						<div class="form-group row d-flex align-items-center mb-5">
							...
							<div class="col-lg-5">
								<input class="form-control" placeholder="Telefon 1" name="phone_1" value="<?php echo isset($form_error) ? set_value("phone_1") : "$item->phone_1"; ?>">
								<?php if (isset($form_error)) { ?>
						...
						<div class="form-group row d-flex align-items-center mb-5">
							...
							<div class="col-lg-5">
								<input class="form-control" placeholder="Telefon 2" name="phone_2" value="<?php echo isset($form_error) ? set_value("phone_2") : "$item->phone_2"; ?>">
								<?php if (isset($form_error)) { ?>
						...
						<div class="form-group row d-flex align-items-center mb-5">
							...
							<div class="col-lg-5">
								<input class="form-control" placeholder="Kurum Yetkilisi Adı" name="administrator_name" value="<?php echo isset($form_error) ? set_value("administrator_name") : "$item->administrator_name"; ?>">
								<?php if (isset($form_error)) { ?>
						...
						<div class="form-group row d-flex align-items-center mb-5">
							...
							<div class="col-lg-5">
								<textarea class="form-control" placeholder="Kurum Adresi ..." required="" name="address" style="margin-top: 0px; margin-bottom: 0px; height: 218px;"><?php echo isset($form_error) ? set_value("address") : "$item->address"; ?></textarea>
							</div>
						</div>
						<div class="form-group row d-flex align-items-center mb-5">
